...
const Toaster = ({ ...props }: ToasterProps) => {
  return (
    <Sonner
      ...
      position="top-right"
      icons={{
        success: <Icon name="check_circle" className="text-primary text-lg" />,
        info: <Icon name="info" className="text-chart-blue text-lg" />,
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            'w-80 sm:w-96 overflow-hidden rounded-[1.5rem] bg-surface-dark/95 backdrop-blur-xl border shadow-2xl p-5 flex items-start gap-4 animate-fade-in-right',
          ...
          actionButton:
            'bg-primary text-background-dark font-black uppercase text-xs px-4 py-2 rounded-xl',
