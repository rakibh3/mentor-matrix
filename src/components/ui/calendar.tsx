  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          'text-text-secondary hover:text-primary absolute left-0 flex size-9 cursor-pointer items-center justify-center rounded-xl bg-transparent transition-colors hover:bg-white/10'
        ),
        button_next: cn(
          'text-text-secondary hover:text-primary absolute right-0 flex size-9 cursor-pointer items-center justify-center rounded-xl bg-transparent transition-colors hover:bg-white/10'
        ),
        ...
        day_button: cn(
          'size-10 cursor-pointer rounded-xl p-0 font-bold transition-all',
          'hover:bg-primary/20 hover:text-primary text-white',
        ...
        outside: 'text-text-secondary/40 hover:text-text-secondary/60',
        disabled:
          'text-text-secondary/20 cursor-not-allowed opacity-30 hover:bg-transparent hover:text-text-secondary/20',
