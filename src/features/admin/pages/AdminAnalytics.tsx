      ...
      <div className="w-full flex flex-col gap-8 selection:bg-primary/30 animate-fade-in-up">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Button className="flex items-center gap-2 bg-primary hover:bg-primary-hover text-background-dark font-black h-10 px-6 rounded-xl text-sm shadow-lg shadow-primary/20 active:scale-95">
